/datum/job/vamp/taxi
	...
	allowed_bloodlines = list("Daughters of Cacaphony", "Salubri", "Nagaraja", "Baali", "Brujah", "Tremere", "Ventrue", "Gangrel", "Toreador", "Malkavian", "Banu Haqim", "Giovanni", "Ministry", "Tzimisce", "Lasombra", "Caitiff", "Kiasyd", "Cappadocian", "Nosferatu")
